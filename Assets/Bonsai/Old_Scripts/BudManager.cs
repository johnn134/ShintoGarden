...
public class BudManager : MonoBehaviour {
	...
	public void processGrowthCycle(GameObject branch, GameObject leaf, GameObject bud) {
		if(isLeaf) {
			...
			newLeaf.transform.GetComponent<LeafManager>().setDepth(depth);
			newLeaf.transform.GetComponent<LeafManager>().setWPosition(w);
			newLeaf.transform.GetComponent<LeafManager>().setManager(manager);

			transform.parent.GetComponent<BranchManager>().registerLeafAdded();
			...
			newBranch.transform.GetComponent<BranchManager>().setDepth(depth);
			newBranch.transform.GetComponent<BranchManager>().setWPosition(w);
			newBranch.transform.GetComponent<BranchManager>().setManager(manager);

			transform.parent.GetComponent<BranchManager>().registerBranchAdded();
