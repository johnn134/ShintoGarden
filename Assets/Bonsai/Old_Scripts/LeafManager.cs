...
public class LeafManager : MonoBehaviour {
	...
	void OnMouseDown() {
		if(canSnip) {
			transform.parent.GetComponent<BranchManager>().registerLeafRemoved();
	...
	bool checkForBranchTip() {
		return transform.parent.GetComponent<BranchManager>().getIsTip();
	}
	...
	bool checkIsParentBranchHigher() {
		return transform.parent.GetComponent<BranchManager>().getIsHigherThanChildren();
	}
