Shader "Cg_Tutorial/Single_Texture_Glossy_Per_Vertex_Lighting_Shader"
{
	Properties
	{
	...
	SubShader
	{
		Pass
		{
			...
			float4 frag (vertexOutput i) : COLOR
			{
				...
				return float4(i.specularColor * (1.0 - textureColor.a) + i.diffuseColor * textureColor.rgb, 1.0);
			}
			ENDCG
		}
